...
<div class="nav-bottom">
    <div>
        ...
        <a href="<?= base_url('/members'); ?>" class=""> <span><i class="fas fa-users"></i></span></a>
        <a href="<?= base_url('/report'); ?>" class="active2"> <span><i class="fas fa-book-open"></i></span></a>
    </div>
</div>
            ...
            <nav class="navbar navbar-expand">
                <div class="collapse navbar-collapse justify-content-between">
                    <div class="header-left ">
                        <div class="dashboard_bar">Laporan</div>
                    </div>
                    <ul class="navbar-nav header-right">
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="<?= base_url('/admin-logout'); ?>" onclick="return confirm('Yakin ingin logout?')" class="dropdown-item ai-icon">
                ...
                <div class="col-12">
                    ...
                    <div class="card laporan-title">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('/report'); ?>" method="post" style="width: 100%;">
